...
def fitness_func(solution, solution_idx):
    ...
    c_lib.c880GetNodeState(ffi.cast("bool *", node_activations.ctypes.data), len(node_activations))
...
number_of_inputs = c880_n_input
number_of_outputs = c880_n_output
number_of_internal_nodes = c880_n_wire

transition_prob = c880_trans_prob
trigger_false_prob = c880_P0
trigger_true_prob = c880_P1
